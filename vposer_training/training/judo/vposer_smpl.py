...
class VPoserTrainer:
    ...
    def __init__(self, work_dir, ps):
        ...
        print(self.ps.bm_path)
        print('--------------')
        self.bm = BodyModel(self.ps.bm_path, None, batch_size=self.ps.batch_size, use_posedirs=True).to(self.comp_device)
    ...
    def perform_training(self, num_epochs=None, message=None):
        ...
        ########################
        vis_bm =  BodyModel(self.ps.bm_path, None, num_betas=16).to(self.comp_device)
        prev_lr = np.inf
